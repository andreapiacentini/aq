...
#ifndef AQ_MODELBIASINCREMENT_H_
#define AQ_MODELBIASINCREMENT_H_
...
/// Constructor, destructor
  ModelBiasIncrement(const GeometryAQ &, const eckit::Configuration &) {}
...
#endif  // AQ_MODELBIASINCREMENT_H_
