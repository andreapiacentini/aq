...
! ------------------------------------------------------------------------------
!> Fill ATLAS fieldset
subroutine aq_geom_fill_atlas_fieldset_c(c_key_self,c_afieldset) &
 & bind(c,name='aq_geom_fill_atlas_fieldset_f90')
...
end subroutine aq_geom_fill_atlas_fieldset_c
! ------------------------------------------------------------------------------
!> Clone geometry
